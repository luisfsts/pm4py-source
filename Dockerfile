...
RUN pip install pyvis networkx==2.2 matplotlib==2.2.2 numpy ciso8601 pyarrow==0.13.0 cvxopt lxml graphviz pandas scipy scikit-learn pytz==2018.9 lime joblib
