...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.other', 'pm4py.algo.other.anchors',
              ...
              'pm4py.algo.other.decisiontree', 'pm4py.algo.other.decisiontree.applications', 'pm4py.algo.discovery',
              ...
              'pm4py.algo.filtering.pandas.start_activities', 'pm4py.algo.prediction', 'pm4py.algo.prediction.versions',
              ...
              'pm4py.util.lp', 'pm4py.util.lp.util', 'pm4py.util.lp.versions', 'pm4py.util.anchors', 'pm4py.objects',
              ...
              'pm4py.visualization.bpmn', 'pm4py.visualization.bpmn.util', 'pm4py.visualization.bpmn.versions',
